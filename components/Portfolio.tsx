...
const Portfolio: React.FC = () => {
  ...
  return (
    <section id="portfolio" className="relative py-32 bg-gray-50 overflow-hidden">
       ...
       <div 
         className="absolute top-20 right-6 pointer-events-none transition-transform duration-100 ease-out"
          ...
          {PROJECTS.map((project, index) => {
            ...
            return (
                ...
                >
                  ...
                  <div className={`overflow-hidden bg-gray-200 w-full h-full relative border-2 border-transparent group-hover:border-primary/50 group-hover:shadow-[0_10px_40px_-10px_rgba(250,92,92,0.3)] transition-all duration-300 rounded-lg ${isFeatured ? 'aspect-[4/3]' : 'aspect-square'}`}>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-dark/90 via-dark/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6 md:p-8">
                        <div className="translate-y-8 group-hover:translate-y-0 transition-transform duration-300 ease-out-expo delay-75">
                           <h3 className="text-white font-heading font-black text-2xl md:text-3xl uppercase mb-2 leading-none">
                              {project.title}
                           </h3>
                           ...
                           <div className="flex items-center gap-3">
                               <button className="flex items-center gap-2 bg-primary hover:bg-red-600 text-white text-xs font-bold uppercase tracking-wider px-4 py-2 rounded-sm transition-colors">
                  ...
                  <div className="absolute -top-2 -left-2 w-6 h-6 border-l-2 border-t-2 border-primary opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:-translate-x-1 group-hover:-translate-y-1"></div>
                  <div className="absolute -bottom-2 -right-2 w-6 h-6 border-r-2 border-b-2 border-primary opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-x-1 group-hover:translate-y-1"></div>
                </div>
            );
          })}
